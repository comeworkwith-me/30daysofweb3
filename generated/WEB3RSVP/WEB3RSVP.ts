...
export class ConfirmedAttendeeCall extends ethereum.Call {
  get inputs(): ConfirmedAttendeeCall__Inputs {
    return new ConfirmedAttendeeCall__Inputs(this);
  }

  get outputs(): ConfirmedAttendeeCall__Outputs {
    return new ConfirmedAttendeeCall__Outputs(this);
  }
}

export class ConfirmedAttendeeCall__Inputs {
  _call: ConfirmedAttendeeCall;

  constructor(call: ConfirmedAttendeeCall) {
    this._call = call;
  }
...
export class ConfirmedAttendeeCall__Outputs {
  _call: ConfirmedAttendeeCall;
